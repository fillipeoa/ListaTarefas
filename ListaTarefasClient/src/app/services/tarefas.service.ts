...
export class TarefasService {
  ...
  atualizarEstatisticas() {
    ...
    this.estatisticas.dia.lista = this.tarefas().filter(tarefa => tarefa.prazo_final === dataFormatada );
  ...
  getInicioSemana(data: Date): Date {
    ...
    const dia = dataClone.getDay();
    const diff = dataClone.getDate() - dia;
    return new Date(dataClone.setDate(diff));
  }
